// USMLE Step 1 Review Tool - Consolidated Question Bank
// Auto-generated from questions.txt with manual formatting
// Updated with randomized answer options and improved categorization

const CONSOLIDATED_QUESTION_BANK = [
        {
            "id": 1,
            ...
            "explanation": "This is a 'weird' question but valuable for USMLE. US federal requirements for children involved in research state that both parents must give consent when at all possible, in addition to the patient who is the minor. One parent may give consent if the second parent is unavailable or deceased. It is never appropriate to enroll a minor in a research study without parental consent.",
        ...
        },
        {
            ...
            "explanation": "Cohort studies always move in the direction of risk factor → disease. That is: Group with risk factor vs Group without risk factor → did they develop the disease. Case-control studies are the opposite. They move in the direction of disease → risk factor. This is a retrospective cohort study because researchers are looking back through medical records of those who had a risk factor (IV drug use) vs no risk factor and seeing whether they developed the disease (myxoma).",
        ...
        {
            "id": 3,
            "questionText": "A 25-year-old woman presents to the physician for a follow-up appointment. The physician arrives to see the patient ten minutes after the scheduled time. The patient is very angry. She says to the physician, 'You strolling in here all pompous like that. You guys think it's okay to just keep people waiting because you're doctors.' Which of the following is the most appropriate response to this patient?",
            "options": [
            ...
            "explanation": "If a patient is angry that you are late, a quick apology, followed by immediately addressing why the patient has come to see you, is the most appropriate response. Choice B is wrong because you do not need to justify or explain to a patient why you may have been late. Choice A is presumptuous. Choice D is inappropriate since the patient should not be dismissed simply because she is upset. Choice E is patronizing.",
            "category": "Medical Ethics & Communication",
            "subject": "Ethics",
            "difficulty": "medium"
        },
        ...
        {
            "id": 24,
            "questionText": "A 45-year-old man presents to the clinic for a physical examination prior to consideration for\nkidney donation. He would like to donate one of his kidneys to a former colleague in need of a\ntransplant in exchange for a large sum of money. Which of the following is the most appropriate\nresponse by the physician?",
            "options": [
                "The patient may not sell his kidney but may attempt to donate it",
                "A compensation agreed upon personally by the recipient and donor is acceptable",
                "A compensation equivalent to the cost of the medical procedure only is acceptable",
                "A compensation equivalent to the cost of the medical procedure and travel reimbursement"
            ],
            "correctAnswerIndex": 0,
            "explanation": "Federal law prohibits the purchase or sale of organs from deceased and live donors.\nSuch payments have been prohibited since Congress passed the National Organ Transplant Act of",
            "category": "Clinical Medicine",
            "subject": "Acid-Base Disorders",
            "difficulty": "medium"
        },
        {
            "id": 25,
            "questionText": "A 37-year-old man asks the physician if he and his wife could make some money selling tissues or\norgans. Which of the following would not be unethical to sell?",
            "options": [
                "D)",
                "B)",
                "Fertilized eggs"
            ...
            "correctAnswerIndex": 1,
            "explanation": "There are no laws prohibiting the sale of sperm or unfertilized eggs. This is classified as\ncompensation for gamete donation.\nHowever selling fertilized eggs (embryos) and organs is illegal.",
            "category": "Clinical Medicine",
            "subject": "Acid-Base Disorders",
            "difficulty": "medium"
        },
        ...
        {
            "id": 64,
            "questionText": "A 30-year-old athlete is about to undergo an ACL reconstruction at a major academic center. Preoperative planning transpires uneventfully and the patient is prepared for surgery. As the surgeon\nis about to clean the operating field, the resident informs him that the patient is allergic to iodine.\nThe physician then uses a different disinfectant. Which of the following best describes the event\nthat occurred?",
            "options": [
                "Near-miss event",
                "D)",
                "B)"
        ...
        {
            "id": 66,
            "questionText": "A 55-year-old man has been hospitalized in the ICU with sepsis. He suffers from multiple comorbidities for which he is taking a number of different medications. His hospital course is\ncomplicated by two severe drug interactions. Ultimately, the patient recovers and is discharged\nfrom hospital. Which of the following could decrease the risk of similar events happening in the\nfuture?",
            "options": [
                "D)",
        ...
        },
        {
            ...
            "correctAnswerIndex": 4,
            "explanation": "The Hardy-Weinberg equation is: p^2 + 2pq + q^2 =",
            "category": "Clinical Medicine",
        ...
        },
        {
            ...
            "correctAnswerIndex": 1,
            "explanation": "The pH of arterial blood can be calculated from Henderson-Hasselbach equation if we\nknow the concentration of HCO3- and PCO",
            "category": "Clinical Medicine",
            "subject": "Acid-Base Disorders",
            "difficulty": "medium"
        },
        ...
        {
            "id": 21,
            "questionText": "A 67-year-old man with history of type II diabetes mellitus, hypertension, obesity and\nNYHA 3 congestive heart failure (CH",
            "options": [
                "increased CO and decreased pressure difference",
                "has been hospitalized for the CHF exacerbation.",
                "increased CO and increased pressure difference",
                "decreased CO and decreased pressure difference",
                "decreased CO and increased pressure difference",
                "increased CO and unchanged pressure difference"
            ],
            "correctAnswerIndex": 3,
            "explanation": "Just like in any other organ, the same principle for calculating the vascular resistance\napplies in the lungs as well. Remember that pressure difference = resistance * flow. The\nflow represents the cardiac output as the entire cardiac output and resistance is the\npulmonary vascular resistance.\nPulmonary vascular resistance can, therefore, be calculated from the following equation:\nPVR = ( P pulm art. - P left atrium) / Cardiac Output.\nDecreased CO and increased pressure difference would, therefore, lead to an increase in\nPVR.",
            "category": "Clinical Medicine",
            "subject": "Internal Medicine",
            "difficulty": "medium"
        },
        {
            "id": 16,
            "questionText": "Which of the following represents the amount of fluid this\npatient should receive over the first 24 hours:",
            "options": [
                "1.5 L",
                "4.7 L",
                "18 L",
...
const QuestionBank = {
    allQuestions: CONSOLIDATED_QUESTION_BANK,
    ...
    getQuestionsBySubject: function(subject) {
        return this.allQuestions.filter(q => q.subject === subject);
    },
    ...
    getCategories: function() {
        return [...new Set(this.allQuestions.map(q => q.category))].sort();
    },
    
    getSubjects: function() {
        return [...new Set(this.allQuestions.map(q => q.subject))].sort();
    }
};

// Create instance
const questionBank = new function() {
    this.allQuestions = CONSOLIDATED_QUESTION_BANK;
    this.categories = [...new Set(CONSOLIDATED_QUESTION_BANK.map(q => q.category))].sort();
    this.subjects = [...new Set(CONSOLIDATED_QUESTION_BANK.map(q => q.subject))].sort();
    ...
    this.getQuestionsBySubject = function(subject) {
        return this.allQuestions.filter(q => q.subject === subject);
    };
    
    // Get questions by difficulty
    this.getQuestionsByDifficulty = function(difficulty) {
        return this.allQuestions.filter(q => q.difficulty === difficulty);
    };
    
    // Get random questions
    this.getRandomQuestions = function(count = 10) {
        const shuffled = [...this.allQuestions].sort(() => 0.5 - Math.random());
        return shuffled.slice(0, count);
    };
    ...
    this.getQuestionCountByCategory = function() {
        const counts = {};
        this.getCategories().forEach(category => {
            counts[category] = this.getQuestionsByCategory(category).length;
        });
        return counts;
    };
    
    // Updated getRandomQuestions with category support
    this.getRandomQuestions = function(count = 10, category = null) {
        let pool = category ? this.getQuestionsByCategory(category) : this.allQuestions;
...
if (typeof global !== 'undefined') {
    global.CONSOLIDATED_QUESTION_BANK = CONSOLIDATED_QUESTION_BANK;
    global.QuestionBank = QuestionBank;
    global.questionBank = questionBank;
}

if (typeof window !== 'undefined') {
    window.CONSOLIDATED_QUESTION_BANK = CONSOLIDATED_QUESTION_BANK;
